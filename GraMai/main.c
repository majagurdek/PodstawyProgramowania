...
int main(int argc, char **argv) {
    ...
    printf("Poruszaj się po mapie używając klawiszy :\nW(góra)\nS(dół)\nA(lewo)\nD(prawo)\nSpróbuj doprowadzić kulkę na zielone pole, nie dotykając ścian.\nMożesz dowolnie edytować mapę w pliku tekstowym, zmieniając jej wymiary, ustawienia ścian, startu i końca (0 oznacza ścieżkę, 1 ścianę, 2 start, 3 koniec).\nPowodzenia!\n");
    //=======================================================
